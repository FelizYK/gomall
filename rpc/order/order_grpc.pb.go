...
type OrderServiceClient interface {
	...
	AddOrder(ctx context.Context, in *AddOrderReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *orderServiceClient) GetOrders(ctx context.Context, in *GetOrdersReq, opts ...grpc.CallOption) (*GetOrdersResp, error) {
...
func (c *orderServiceClient) AddOrder(ctx context.Context, in *AddOrderReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	AddOrder(context.Context, *AddOrderReq) (*emptypb.Empty, error)
...
func (UnimplementedOrderServiceServer) GetOrders(context.Context, *GetOrdersReq) (*GetOrdersResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOrders not implemented")
}
func (UnimplementedOrderServiceServer) AddOrder(context.Context, *AddOrderReq) (*emptypb.Empty, error) {
