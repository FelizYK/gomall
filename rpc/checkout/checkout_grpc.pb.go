...
type CheckoutServiceClient interface {
	Checkout(ctx context.Context, in *CheckoutReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *checkoutServiceClient) Checkout(ctx context.Context, in *CheckoutReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type CheckoutServiceServer interface {
	Checkout(context.Context, *CheckoutReq) (*emptypb.Empty, error)
...
func (UnimplementedCheckoutServiceServer) Checkout(context.Context, *CheckoutReq) (*emptypb.Empty, error) {
