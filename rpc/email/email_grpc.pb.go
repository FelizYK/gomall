...
type EmailServiceClient interface {
	SendEmail(ctx context.Context, in *SendEmailReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *emailServiceClient) SendEmail(ctx context.Context, in *SendEmailReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type EmailServiceServer interface {
	SendEmail(context.Context, *SendEmailReq) (*emptypb.Empty, error)
...
func (UnimplementedEmailServiceServer) SendEmail(context.Context, *SendEmailReq) (*emptypb.Empty, error) {
