...
const (
	HomeService_Home_FullMethodName = "/frontend.home.HomeService/Home"
)
...
type HomeServiceClient interface {
	Home(ctx context.Context, in *common.Empty, opts ...grpc.CallOption) (*common.Empty, error)
}
...
func (c *homeServiceClient) Home(ctx context.Context, in *common.Empty, opts ...grpc.CallOption) (*common.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Empty)
	err := c.cc.Invoke(ctx, HomeService_Home_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HomeServiceServer interface {
	Home(context.Context, *common.Empty) (*common.Empty, error)
...
func (UnimplementedHomeServiceServer) Home(context.Context, *common.Empty) (*common.Empty, error) {
...
func _HomeService_Home_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HomeServiceServer).Home(ctx, req.(*common.Empty))
	}
...
var HomeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "frontend.home.HomeService",
